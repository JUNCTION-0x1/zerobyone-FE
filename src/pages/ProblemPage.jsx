  ...
  const problems = [
    {
      ...
      choices: ['오늘 날씨 어때?', '오늘 기분 어때?', '오늘 한 잔 어때?'],
      answer: '오늘 기분 어때?'
    },
            ...
            {isCorrect ? (
              <div>
                ...
                <div style={{ marginBottom: '12px' }}>
                  {' '}
                  {/* 15px에서 12px로 줄임 */}
                  <p style={{ fontSize: '16px', marginBottom: '5px', color: '#333' }}>Work a little faster.</p>
                  <p style={{ fontSize: '16px', marginBottom: '12px', color: '#666' }}>
                    {' '}
                    {/* 15px에서 12px로 줄임 */}= "좀 더 빨리 일해라."
                  </p>
                </div>
                ...
                <div style={{ marginBottom: '20px' }}>
                  {' '}
                  {/* 25px에서 20px로 줄임 */}
                  <p style={{ fontSize: '16px', marginBottom: '5px', color: '#333' }}>Work a little faster, please.</p>
                  <p style={{ fontSize: '16px', marginBottom: '12px', color: '#666' }}>
                    {' '}
                    {/* 15px에서 12px로 줄임 */}= "조금만 더 빨리 해주세요."
                  </p>
                </div>
